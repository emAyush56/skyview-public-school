...
import BannerImg from "../assets/img/boy-in-blue-t-min.jpg";
const featuresDescribed = [
  ...
  },
  {
    ...
    description:
      "The school playground is one of the most important things to keep students fit and healthy. Playing creates a positive psychological effect on students' minds. Playing and outdoor activities will help our students to boost their confidence.",
  },
];
...
export default function Home() {
  return (
    <>
      <main className="container mx-auto my-20 max-w-6xl px-10 lg:my-36 lg:px-0">
        {/* HERO SECTION */}
        ...
        <section className="hero mx-auto text-center sm:max-w-3xl">
          ...
          <p className="hero-desc mt-6 w-full text-base text-gray-primary lg:text-lg">
            As a school of the 21st century, we intend to guide our students
            into pursuing excellence. Our course curiculum is based on CBSE -{" "}
            <span className="font-semibold underline decoration-2 underline-offset-4">
              admissions are open for session 2023.
            </span>
          </p>
        </section>

        {/* FEATURES DESCRIBED SECTION */}

        <section className="featuresDescribed mt-28 lg:mt-36">
          <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 sm:gap-x-16 sm:gap-y-14 lg:gap-x-32">
          ...
          <div className="banner_board group flex flex-col items-center overflow-hidden bg-gray-alt pb-4 duration-300 ease-in-out hover:bg-white lg:flex-row lg:pb-0">
            ...
            <div className="banner__content px-8 py-6 text-gray-primary lg:px-16 lg:py-10">
              ...
              <p className="mt-6 text-base font-medium lg:text-lg">
                We propose to be 10+2 as we grow in the near future. However,
                our courses are currently available up to the 5th standard
                (class V).
              </p>
              <p className="mt-6 text-base font-medium lg:text-lg">
        ...
        <section className="quickContact mt-14 md:mt-36 lg:h-[315px]">
          <div className="quickContact__warp flex h-full flex-col gap-y-6 md:flex-row md:gap-4">
            ...
            <div className="quickContact__contactDetails h-full basis-1/2 lg:px-16">
              ...
              <p className="mt-5 text-base text-gray-primary md:text-lg">
                Address: Near Kalibari GS Steel Furniture, Uttar Andaran
                Fulbari, Tufanganj - 736160, Coochbehar.
              </p>
